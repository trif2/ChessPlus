...
namespace ChessPlus.Pieces
{
    ...
    {
        public static ClassicPiece CreateClassicPiece(char pieceAbbrev)
        {
            ClassicPiece piece = pieceAbbrev switch
            {
        ...
        public static HexPiece CreateHexPiece(char pieceAbbrev)
        {
            HexPiece piece = pieceAbbrev switch
            {
